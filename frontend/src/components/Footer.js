      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center justify-center lg:justify-start mb-6">
              <img
                ...
                alt="DACHCart Logo"
                className="w-48 h-20 md:w-56 md:h-24 object-contain -ml-2"
              />
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed mb-6 text-center lg:text-left">
              ...
              prices. Elevate your lifestyle with DACH.
            </p>
          ...
          <div className="lg:col-span-2 bg-white/5 rounded-3xl p-8 border border-white/10">
            ...
            <h3 className="text-xl font-bold text-white mb-3">DACH Mobile App</h3>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-6">
            <p className="text-gray-500 text-xs font-medium">
              © 2025 DACHCart. All rights reserved.
            </p>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 text-gray-500">
              ...
              <span className="text-xs font-bold">DACHcart0712@gmail.com</span>
            </div>
            <div className="h-4 w-px bg-gray-800 hidden md:block"></div>
            <div className="flex items-center gap-2 text-gray-500">
