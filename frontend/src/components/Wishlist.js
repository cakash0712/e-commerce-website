            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 text-left">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-3xl md:text-5xl font-bold text-gray-900 tracking-tight leading-tight">Curated <span className="text-violet-600">Favorites</span></h1>
                    <p className="text-gray-500 font-medium mt-1">Managed assets and saved merchandise</p>
                  </div>
                </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-24">
          {wishlistItems.length > 0 ? (
            ...
            <div className="py-24 max-w-lg mx-auto text-center animate-in zoom-in duration-700">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4 tracking-tight leading-tight text-center">Your wishlist is <span className="text-violet-600">uninhabited.</span></h2>
              <p className="text-gray-500 font-medium mb-12 leading-relaxed text-center">
                Seal your favorite artifacts by clicking the heart icon on any product description. They'll be securely cached here for your next session.
              </p>
              <Link to="/shop">
